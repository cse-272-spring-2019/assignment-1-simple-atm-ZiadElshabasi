	  ...
	  @Override
	    public void start(Stage primaryStage) throws Exception {
			...
			submit.setText("submit");
			  ...
			  B1.setPrefSize(40,40);
			     B2.setPrefSize(40,40);
			     B3.setPrefSize(40,40);
			     B4.setPrefSize(40,40);
			     B5.setPrefSize(40,40);
			     B6.setPrefSize(40,40);
			     B7.setPrefSize(40,40);
			     B8.setPrefSize(40,40);
			     B9.setPrefSize(40,40);
			     B0.setPrefSize(40,40);
			     del.setPrefSize(40,40);
			     
			     pinLabel.setPrefWidth(220);
			     pinLabel.setPrefHeight(30);
			     userIdLabel.setPrefWidth(220);
			     userIdLabel.setPrefHeight(30);
			     
			     pinLabel.setFont(Font.font("Georgia",30));
			     userIdLabel.setFont(Font.font("Georgia",20));
		    // userIdLabel.setTextFill(Color.web("#A9A9A9"));
			     userIdLabel.setTextFill(Color.web("CD853F"));
			...
			B0.setOnAction(e->{s=s+"0";pinLabel.setText(s);	if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  B1.setOnAction(e->{s=s+"1";pinLabel.setText(s);if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  B2.setOnAction(e->{s=s+"2";pinLabel.setText(s);if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  B3.setOnAction(e->{s=s+"3";pinLabel.setText(s);if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  B4.setOnAction(e->{s=s+"4";pinLabel.setText(s);if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  B5.setOnAction(e->{s=s+"5";pinLabel.setText(s);if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  B6.setOnAction(e->{s=s+"6";pinLabel.setText(s);if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  B7.setOnAction(e->{s=s+"7";pinLabel.setText(s);if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  B8.setOnAction(e->{s=s+"8";pinLabel.setText(s);if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  B9.setOnAction(e->{s=s+"9";pinLabel.setText(s);if (s.length()<4) {pinLabel.setTextFill(Color.web("#B22222"));}else pinLabel.setTextFill(Color.web("006400"));});
			  del.setOnAction(e->{StringBuffer sb=new StringBuffer(s);
		sb.deleteCharAt(sb.length()-1);
		s= new String(sb);
		pinLabel.setText(s);
		if (s.length()<4) pinLabel.setTextFill(Color.web("#B22222"));
		else pinLabel.setTextFill(Color.web("006400"));
		});
			// Scene
			...
			withdraw.setPrefSize(100,40);
		    deposit.setPrefSize(100,40);
		    balanceInquiry.setPrefSize(100,40);
			...
			GridPane.setConstraints(history , 1 ,5);
			GridPane.setConstraints(history2 , 2 ,5);
			GridPane.setConstraints(previous , 0 ,4);
			GridPane.setConstraints(next , 1 ,4);
			GridPane.setConstraints(logout , 7 ,7);
			grid2.getChildren().addAll( deposit , withdraw , balanceInquiry , history , history2, previous , next , logout );
			history.setFont(Font.font("Georgia",10));history2.setFont(Font.font("Georgia",15));
			//scene
		...
		//////Scene deposit//////////////
					...
					Button back2 =new Button("back");
					  ...
					  B11.setPrefSize(40,40);
					     B22.setPrefSize(40,40);
					     B33.setPrefSize(40,40);
					     B44.setPrefSize(40,40);
					     B55.setPrefSize(40,40);
					     B66.setPrefSize(40,40);
					     B77.setPrefSize(40,40);
					     B88.setPrefSize(40,40);
					     B99.setPrefSize(40,40);
					     B00.setPrefSize(40,40);
					     dele.setPrefSize(40,40);
					     dot.setPrefSize(40,40);
					     
					     depLabel.setPrefWidth(250);
					     depLabel.setPrefHeight(30);
					     depLabel.setFont(Font.font("Arial",30));
					...
					Button back3 =new Button("back");
					  ...
					  B111.setPrefSize(40,40);
					     B222.setPrefSize(40,40);
					     B333.setPrefSize(40,40);
					     B444.setPrefSize(40,40);
					     B555.setPrefSize(40,40);
					     B666.setPrefSize(40,40);
					     B777.setPrefSize(40,40);
					     B888.setPrefSize(40,40);
					     B999.setPrefSize(40,40);
					     B000.setPrefSize(40,40);
					     del3.setPrefSize(40,40);
					     dot3.setPrefSize(40,40);
					
					     withdrawLabel.setFont(Font.font("Arial",30));
					...
					B000.setOnAction(e->{with=with+"0";if (with.charAt(0)=='0') {with="";}
					withdrawLabel.setText(with);
					if (Double.parseDouble(with)>account.getBalance()){withdrawLabel.setTextFill(Color.web("B22222"));} 
					else withdrawLabel.setTextFill(Color.web("006400"));});
					...
					dot3.setOnAction(e->{with=with+".";withdrawLabel.setText(with);
					if (Double.parseDouble(with)>account.getBalance()){withdrawLabel.setTextFill(Color.web("B22222"));}
					else withdrawLabel.setTextFill(Color.web("006400"));});
					...
					//////Scene balanceInquiry//////////////
						...
						format.setText("Your balance is : ");format.setFont(Font.font("Georgia",30));
						Button back4= new Button();
						back4.setText("back");
						balance.setFont(Font.font("Arial",30));
						
						// GridPane
						GridPane grid5 = new GridPane();
						grid5.setAlignment(Pos.BASELINE_CENTER);
